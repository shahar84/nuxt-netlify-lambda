...
const cors = __webpack_require__(122);

const serverless = __webpack_require__(124);
...
const exampleHandler = __webpack_require__(137);
...
router.get('/example/', exampleHandler); // router.get("/joke/:id", (req, res) => res.json({ route: req.originalUrl }));
...
const getFramework = __webpack_require__(126);
const getProvider = __webpack_require__(128);
...
const Response = __webpack_require__(127);
...
const aws = __webpack_require__(129);
...
const cleanUpEvent = __webpack_require__(130);

const createRequest = __webpack_require__(131);
const formatResponse = __webpack_require__(133);
...
const Request = __webpack_require__(132);
...
const isBinary = __webpack_require__(134);
const Response = __webpack_require__(127);
